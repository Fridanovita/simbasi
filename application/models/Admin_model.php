    ...
    private function _validasi()
{
    ...
    // Metode untuk mendapatkan detail barang
    public function getDetailBarang($id_barang)
    {
        return $this->db->get_where('detail_barang', ['barang_id' => $id_barang])->result_array();
    }

    // Metode untuk menambahkan detail barang
    public function editDetailBarang($id_detail)
    {
        return $this->db->get_where('detail_barang', ['id_detail' => $id_detail])->row_array();
    }

    // Metode untuk menghapus detail barang
    public function deleteDetailBarang($id_detail)
    {
        return $this->db->delete('detail_barang', ['id_detail' => $id_detail]);
    }
