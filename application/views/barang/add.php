    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="jenis_id">Jenis Perangkat</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="nama_barang">Nama Perangkat</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('nama_barang'); ?>" name="nama_barang" id="nama_barang" type="text" class="form-control" placeholder="Nama Perangkat...">
